...
public class UserServiceTest extends WebAppConfigurationAware{
	...
	public void init() throws UserStorageException{
		...
		userService.save(new User("fpetru", "pdivasto@gmail.com", "pass1", "ADMIN", "Petrus", "Frank", "+49162123456", "+49162123456"));
	...
	@Test
	public void shouldSendEmailWithPassword() throws UserAccessException{
		User user = userService.findByUserName("fpetru");
		//userService.rememberPassword(username, email);(user.getUserName());
	}
