...
public class TestData extends WebAppConfigurationAware{
	...
	public void init() throws UserStorageException, FileNotFoundException, AssignmentStorageException, UserAccessException, InspectionObjectStorageException, InspectionObjectAccessException, AssignmentAccessException{
		...
		Task task2 = new Task("Check computer of the secretary", "Check computer of the secretary", Task.STATE_ERROR);
		...
		gridFsService.addAttachmentDetails(as1.getAttachments());
		...
		assignmentService.createAssignment(as1);
		as2.setTasks(new ArrayList<Task>());
		assignmentService.save(as2);
	}
	
	@Test
	public void testStoreOfData() throws AssignmentAccessException, AssignmentStorageException, UserAccessException{
		Assignment a = assignmentRepository.findByAssignmentName("Check computers of the Studentenwerk office");
//		System.out.println(a.toDescription());
		//mailService.sendEmailToAdminsWithAssignmentDetails("Assignment finished", "Assignment finished", a);
	}
